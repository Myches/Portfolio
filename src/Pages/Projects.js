...
<div className='flex flex-col items-center lg:w-1/2 w-full lg:mt-0 mt-8'>
  ...
  <p className='   text-gray-500  w-[80%] mx-auto'>A beauty ecommerce web app created using react and typescript, that Features product listings, search, and browsing functionality.</p>
...
<div className='lg:flex-row flex flex-col'>
 ...
 <div class="hidden group-hover:block absolute top-0 left-0 bg-gray-500 text-black p-4 w-[550px] h-[278px] hover:scale-110 transition ease-in-out font-bold ">
    <h1 className='absolute top-[25%] left-[40%] text-gray-950 text-lg'>TECH USED :</h1>
    <Fade  bottom>  <h1 className='absolute top-[40%] left-[20%] textbtn text-xl'>NEXT JS + TYPESCRIPT +  FIREBASE</h1></Fade>
  </div>
 </div>

 <div className='flex flex-col items-center lg:w-1/2 w-full lg:mt-0 mt-8'>
  <h1 className=' mb-8 mx-auto text-gray-500 text-2xl flex justify-center items-center'>DEVLINKS</h1>
 <p className='  text-gray-500 w-[80%] mx-auto'>A Full-Stack Link Sharing Application built with Next.js allows users to sign up, log in, and create a personalized profile</p>
 <div className='md:flex-row md:space-x-12 flex flex-col md:space-y-0 space-y-8 mt-[80px]'> <a className='bg-teal-500  p-4 border rounded-lg text-black border-black font-bold w-[150px] flex justify-center items-center hover:bg-gray-400' href="https://linksters.netlify.app/" target="_blank" rel="noopener noreferrer" >LIVE</a>
  <a className='bg-teal-500  p-4  border rounded-lg text-black border-black font-bold hover:bg-gray-400 w-[150px] flex justify-center items-center' href="https://github.com/Myches/linksters.git" target="_blank" rel="noopener noreferrer">GITHUB</a>
  </div>
 </div>
</div>
</Fade>
...
<div className='lg:flex-row flex flex-col'>
 <div className='lg:w-1/2 w-full hover:scale-110 transition ease-in-out cursor-pointer md:flex md:flex-col md:justify-center md:items-center group relative'>
 <img src={fluxdevs} alt="img" className='border border-gray-400 '/>
 <div class="hidden group-hover:block absolute top-0 left-0 bg-gray-500 text-black p-4 w-[550px] h-[278px] hover:scale-110 transition ease-in-out font-bold ">
    <h1 className='absolute top-[25%] left-[40%] text-gray-950 text-lg'>TECH USED :</h1>
    <Fade  bottom>  <h1 className='absolute top-[40%] left-[20%] textbtn text-xl'>REACT + TYPESCRIPT +  REACT-SLICK</h1></Fade>
  </div>
 </div>

 <div className='flex flex-col items-center lg:w-1/2 w-full lg:mt-0 mt-8'>
  <h1 className=' mb-8 mx-auto text-gray-500 text-2xl flex justify-center items-center'>FUXDEVS</h1>
 <p className='  text-gray-500 w-[80%] mx-auto'>A website for a web development company built using React and Typescript  </p>
 <div className='md:flex-row md:space-x-12 flex flex-col md:space-y-0 space-y-8 mt-[80px]'> <a className='bg-teal-500  p-4 border rounded-lg text-black border-black font-bold w-[150px] flex justify-center items-center hover:bg-gray-400' href="https://fluxdevs.netlify.app/" target="_blank" rel="noopener noreferrer" >LIVE</a>
  <a className='bg-teal-500  p-4  border rounded-lg text-black border-black font-bold hover:bg-gray-400 w-[150px] flex justify-center items-center' href="https://github.com/Myches/fluxdev.git" target="_blank" rel="noopener noreferrer">GITHUB</a>
  </div>
 </div>
</div>
</Fade>
